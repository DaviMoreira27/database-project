...
-- Status de um ponto de retirada
...
-- Usuários do sistema (cliente, gerente, admin)
...
-- Gerentes vinculados a uma provedora
...
-- Infraestruturas pertencentes às provedoras (totens, pontos etc.)
...
-- Sistema de relatórios e avaliações

-- Reporte de problemas criado por usuários
...
-- Sistema de bicicletas (retirada e aluguel)
...
-- Registro de retirada de bicicletas
...
-- Histórico de aluguéis de bicicletas
